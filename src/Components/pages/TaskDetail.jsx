...
const TaskDetail = () => {
  ...
  return (
    <div className='column'>
      ...
      <div className='hints'>
        <button className='hint' onClick={() => handleUseHint(1)}>{hint1 ? hint1 : -task?.hint1_price}</button>
        <button className='hint' onClick={() => handleUseHint(2)}>{hint2 ? hint2 : -task?.hint2_price}</button>
        <button className='hint' onClick={() => handleUseHint(3)}>{hint3 ? hint3 : -task?.hint3_price}</button>
      </div>
